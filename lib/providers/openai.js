...
// Sem `temperature`: os modelos de raciocínio da OpenAI (e vários serviços
// compatíveis) rejeitam qualquer valor diferente do padrão com HTTP 400, e o
// determinismo aqui já vem do response_format com schema.
...
export function parseResponse(json) {
  const choice = Array.isArray(json && json.choices) ? json.choices[0] : null;
  if (!choice) {
